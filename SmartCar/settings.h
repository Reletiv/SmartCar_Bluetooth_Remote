...
// H Brug
#define IN1 2      // Rechter Motor 3
#define IN2 3      // Rechter Motor2
...
#define TRG2  A1   // Trigger Rechts
#define TRG3  A2   // Trigger Links
#define ECHO1 8    // Echo Voor
#define ECHO2 9    // Echo Rechts
#define ECHO3 11   // Echo Links
...
// Overig
#define SW1  5     // (P5) MENU Knop
#define SW2  6     // (P6) ENTER Knop
#define LED1 10    // Richtingaanwijzer Links
#define LED2 A3    // Richtingaanwijzer Rechts
//#define BUZZ 0   // Buzzer
//#define LAMP 7   // (P7) Koplampen
...
#define SLAVESTRAIGHTSPEED 85  // Snelheid Rechtdoor rijden
